...
public class Proveedor {
    ...
    private String povCelular;

    public Proveedor() {
    }

    public Proveedor(String provRuc, String provRazonSocial, String provRepresentante, String provDireccion, String provCorreo, String provWeb, String povCelular) {
    ...
    public String getPovCelular() {
        return povCelular;
    }

    public void setPovCelular(String povCelular) {
        this.povCelular = povCelular;
    }
