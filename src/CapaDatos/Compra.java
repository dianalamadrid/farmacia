...
public class Compra {
    ...
    public Compra(int idcompra, String coFecha, String coTipoDoc, String conNroDoc, String coTipoPago, String coFormaPago, String coMoneda, double coSubTotal, double coFlete, double coIgv, double coTotal, String provRuc, String uDni, String tienda) {
        this.idcompra = idcompra;
        this.coFecha = coFecha;
        this.coTipoDoc = coTipoDoc;
        this.conNroDoc = conNroDoc;
    ...
    public String getConNroDoc() {
        return conNroDoc;
    }

    public void setConNroDoc(String conNroDoc) {
        this.conNroDoc = conNroDoc;
    }
